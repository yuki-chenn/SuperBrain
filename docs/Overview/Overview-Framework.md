...
> ✅ **重构状态（2026-06）**：数据库 + RBAC + Challenge Runtime + Catalog + Leaderboard + Concurrency + Submissions 全部 7 个 OpenSpec change 已完成。完整模块总览参见：
>
> | Overview | 范围 |
> |---|---|
> | [`Overview-Database.md`](./Overview-Database.md) | 40 模型 / 27 枚举 / 8 数据域 |
> | [`Overview-Auth-Identity.md`](./Overview-Auth-Identity.md) | RBAC + AuthSession |
> | [`Overview-Game-Catalog.md`](./Overview-Game-Catalog.md) | Game / Difficulty / Policy / Puzzle 版本化 |
> | [`Overview-Challenge-Runtime.md`](./Overview-Challenge-Runtime.md) | 挑战状态机 + 6 端点 + GameRuntimeAdapter |
> | [`Overview-Leaderboard.md`](./Overview-Leaderboard.md) | ScoreRecord/Best/RankCache 三层管道 |
> | [`Overview-Concurrency.md`](./Overview-Concurrency.md) | Redis 锁 / 幂等 / 仲裁 / 健康检查 |
> | [`Overview-Frontend.md`](./Overview-Frontend.md) | apps/web + apps/admin 架构 |
>
> 新增游戏：从 [`docs/rules/rule-add-new-game.md`](./rules/rule-add-new-game.md) 开始；零 schema 变更、零新端点。
>
> 注：本文件 §3 之后描述的是 **重构前** 的旧 API/前端结构，仅供历史比对，**不再代表当前实现**。
