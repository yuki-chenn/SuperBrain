import { coordKey, isInBounds } from './coord.js';
import { createInitialState, executeDirection } from './simulator.js';
...
export function validateReferenceSolution(puzzle, solution) {
...
function computeRequiredVisitCellCount(puzzle) {
...
export function validateAbsoluteCommandPuzzle(puzzle, referenceSolution) {
