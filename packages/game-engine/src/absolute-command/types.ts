...
export const ALL_DIRECTIONS: AbsoluteCommandDirection[] = [
...
export type AbsoluteCommandCellType =
  | 'NORMAL'
  | 'YELLOW_STOP'
  | 'NUMBER'
  | 'INITIAL_RED'
...
export interface AbsoluteCommandPuzzleValidationReport {
  valid: boolean;
  errors: Array<{ code: string; message: string; coord?: MazeCoord }>;
  warnings: Array<{ code: string; message: string; coord?: MazeCoord }>;
...
export const AC_MAZE_WIDTH = 8;
export const AC_MAZE_HEIGHT = 8;
export const AC_MAZE_DEPTH = 3;
export const AC_TOTAL_CELLS = AC_MAZE_WIDTH * AC_MAZE_HEIGHT * AC_MAZE_DEPTH;
