...
// ─── Completion check ───────────────────────────────────────────────
function computeRequiredVisitCells(puzzle) {
    const required = [];
    for (const cell of puzzle.cells) {
        if (cell.type === 'DISABLED' || cell.type === 'INITIAL_RED')
            continue;
...
export function isCompleted(state, puzzle) {
...
export function executeDirection(input) {
...
// ─── Undo ───────────────────────────────────────────────────────────
export function undoCommand(state) {
...
export function buildPuzzleSnapshot(puzzleId, puzzleVersion, size, startCoord, cells) {
