...
export function validateLocalCells(input: ValidateLocalCellsInput): ValidateLocalCellsResult {
...
export function isSameLocalCellSet(a: LocalCellCoord[], b: LocalCellCoord[]): boolean {
  if (a.length !== b.length) return false;

  const normalize = (cells: LocalCellCoord[]) =>
...
export function validateRegionSubmission(input: ValidateRegionSubmissionInput): { correct: boolean } {
