...
function ClientBadge({ client }) {
    if (client === 'admin')
        return _jsx("span", { className: "inline-block px-2 py-0.5 rounded text-xs font-medium bg-blue-500/15 text-blue-400", children: "Admin" });
    if (client === 'game')
        return _jsx("span", { className: "inline-block px-2 py-0.5 rounded text-xs font-medium bg-emerald-500/15 text-emerald-400", children: "Game" });
    return _jsx("span", { className: "text-xs text-[var(--sb-text-muted)]", children: "-" });
}
